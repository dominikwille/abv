...
\end{verbatim}
an. Um Textteile so auszugeben wir sie im Tex-Dokument stehen gibt es die \textit{verbatim}-umgebeung. 
\\ \\
\verb+\begin{verbatim}+\\
\verb+  ...+\\
\verb+\end{verbatim}+\\
...
Die Fußnote wird dann auf der aktuellen Seite im Unteren Bereich der Seite angezeigt.
\begin{verbatim}
